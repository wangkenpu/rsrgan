...
train_dir=data/train/train_100h_mfcc
#train_dir=data/train/train_390h
#test_dir=data/test/test001_mfcc
#test_dir=data/test/test001_simulated
test_dir=data/test/test3000_mfcc
logdir=exp
...
if [ $stage -le 3 ]; then
  ...
  TF_CPP_MIN_LOG_LEVEL=2 python scripts/train_dnn.py \
      --decode \
      --data_dir=$train_dir \
