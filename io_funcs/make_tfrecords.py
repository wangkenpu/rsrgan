...
def make_config_file(name, output_dir, inputs_scp, labels_scp=None):
...
def convert_to(name, inputs_scp, labels_scp,
    ...
    if test:
        make_config_file(name, output_dir, inputs_scp)
    else:
        make_config_file(name, output_dir, inputs_scp, labels_scp)
...
def main(unused_argv):
    ...
    convert_to(FLAGS.name, FLAGS.inputs, FLAGS.labels,
